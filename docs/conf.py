#!/usr/bin/env python
"""
runner documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "runner"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import runner.core  # noqa
...
project = "runner"
_full_version = runner.core.__version__
author = runner.core.__author__
copyright = runner.core.__copyright__
